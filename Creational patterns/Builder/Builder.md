...
객체를 단계적으로 생성하는 기법이다.
복잡한 객체의 생성을 단계로 나누어 다양한 조합의 인스턴스를 생성할 수 있다.
...
Builder를 활용하여 복잡한 객체의 생성을 재료별로 단계를 나누어 생성하였다.
...
Builder를 사용하면 복잡한 객체의 생성을 쉽게 구현할 수 있다.
그러나 python은 객체의 생성이 어려운 편이 아니니 Builder 사용을 잘 생각해보길 바란다.
